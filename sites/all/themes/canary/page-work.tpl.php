  ...
  <div id="page"><div id="trees"><div id="page-inner" class="container">
    ...
    <div id="content" class="span-24">
      ...
      <div id="top-feature" class="span-24">
        <div id="feature-text" class="span-9">
          <?php if ($title): ?>
        ...
        <div id="feature-image" class="span-15 last rounded-top-large">
      ...
      <div id="main-content" class="span-22 prepend-1 append-1 last">
        ...
        <?php if($right): ?>
          <div id="content-right" class="span-11 last">
            <?php if ($right): ?>
