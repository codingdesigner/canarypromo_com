    ...
    <div class="message-holder">
        <div class="heading">
	          <hgroup>
	            ...
	            <h3 class="title"><?php print l($fields['title']->content, 'node/'.$fields['field_related_node_nid']->raw, $options);?></h3>
        ...
        <div class="more-info">
          ...
          <div class="morelink"><?php print l('See and learn more', 'node/'.$fields['field_related_node_nid']->raw, $options); ?></div>
        </div>
    </div>
